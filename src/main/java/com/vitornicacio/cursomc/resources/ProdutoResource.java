...
import com.vitornicacio.cursomc.dto.ProdutoDTO;
import com.vitornicacio.cursomc.resources.utils.URL;
import com.vitornicacio.cursomc.services.ProdutoService;
...
public class ProdutoResource {
	...
	public ResponseEntity<Page<ProdutoDTO>> findAllPage(
		...
		Page<ProdutoDTO> produtos = lista.map(obj -> new ProdutoDTO(obj));
